...
export const VEHICLE_MAKES: BrandLogo[] = [
  ...
  { name: "Corvette C8", logo: "/images/logos/chevrolet.svg", href: "/corvette-ppf", alt: "Corvette C8 Z06 and E-Ray paint protection film in Chantilly, VA", caption: "C8 Z06, E-Ray", width: 24, height: 24 },
  ...
  { name: "Ford", logo: "/images/logos/ford.svg", href: "/bronco-ppf", alt: "Ford Bronco and classic Mustang paint protection film in Chantilly, VA", caption: "Bronco, 1967 Mustang", width: 24, height: 24 },
