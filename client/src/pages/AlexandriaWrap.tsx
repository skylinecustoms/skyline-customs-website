 ...
 * Vinyl Wraps in Vinyl Wraps in Alexandria, VA
 * URL: /vinyl-wraps-alexandria-va
 */
...
const faqs = [
  {
    q: "Do you serve Vinyl Wraps in Alexandria, VA for PPF?",
...
export default function AlexandriaWrap() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Vinyl Wraps Alexandria VA | Car Wrap Near Me"
        description="Top-rated vinyl wrap installer serving Vinyl Wraps in Alexandria, VA. Rock chip protection, self-healing PPF, and full-vehicle coverage. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/vinyl-wraps-alexandria-va"
        jsonLd={[
          {
            ...
            "areaServed": ["Vinyl Wraps in Alexandria, VA", "Chantilly, VA", "Northern Virginia"],
            "aggregateRating": {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Vinyl Wraps in Alexandria, VA", "item": "https://www.skylinecustomshop.com/vinyl-wraps-alexandria-va" }
            ]
          }
        ]}
      />
      ...
      <section className="relative min-h-[55vh] flex items-end pb-16 overflow-hidden">
        ...
        <div className="container relative z-10 pt-32">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[#E85D04] text-sm font-bold tracking-widest uppercase">Vinyl Wraps in Alexandria, VA</span>
          </div>
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated vinyl wrap installer, just 25 minutes from Alexandria via I-66 or Route 50. Protect your paint from rock chips and road debris with self-healing film.
            </p>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why Vinyl Wraps in Alexandria</p>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            VINYL WRAP QUESTIONS FROM ALEXANDRIA DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT ALEXANDRIA DRIVERS SAY ABOUT OUR WRAPS" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free vinyl wrap quote from Northern Virginia's top-rated installer. Just 25 minutes from Alexandria.
          </p>
      ...
      <NearbyAreas city="Alexandria" service="wrap" />
