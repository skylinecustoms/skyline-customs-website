 ...
 * Window Tinting in Vienna, VA
 * URL: /window-tinting-vienna-va
 */
...
const faqs = [
  {
    q: "Do you serve Vienna, VA for window tinting?",
  ...
  {
    q: "How much does window tinting cost near Vienna?",
  ...
  {
    q: "What are Virginia's window tinting laws?",
    a: "Virginia law requires front side windows to allow at least 50% light transmission (VLT). Rear side and back windows can be darker. We ensure every install is fully compliant with Virginia tinting regulations.",
  },
  {
    q: "How long does window tinting take?",
    a: "Most window tint installs are completed in 2–4 hours depending on vehicle size and film type. We'll give you a firm timeline when you book.",
  },
  {
    q: "Do you offer ceramic window tint near Vienna?",
    a: "Yes — we offer premium ceramic window film that blocks up to 99% of UV rays and significantly reduces heat without interfering with electronics or GPS signals.",
  },
  {
    q: "How long does window tint last?",
    a: "Quality window tint from reputable brands like 3M, Llumar, and SunTek typically lasts 10+ years with proper care. We back our installs with a manufacturer warranty.",
  },
];
...
export default function ViennaTint() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Window Tinting Vienna VA | Car Tint Near Me"
        description="Top-rated window tinting installer serving Vienna, VA. UV protection, heat rejection, and Virginia-legal tint. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/window-tinting-vienna-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Vienna, VA", "item": "https://www.skylinecustomshop.com/window-tinting-vienna-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated window tinting installer, just 15 minutes from Vienna via Route 123. Block UV rays, reduce heat, and enhance privacy with premium film.
            </p>
            <div className="flex flex-wrap gap-3 mb-6">
              {["5.0 ★ Google Rating", "Free Quotes", "Virginia Legal", "Ceramic Film Available"].map((b) => (
      ...
      {/* Why Tint near Vienna */}
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why Window Tinting in Vienna</p>
            <h2 className="font-['Bebas_Neue',sans-serif] text-5xl text-white">BEAT THE NOVA HEAT & GLARE</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              { icon: Shield, title: "99% UV Rejection", desc: "Block harmful UV rays that fade your interior and damage your skin during long commutes on Route 123 and I-66." },
              { icon: Star, title: "Heat Reduction", desc: "Ceramic film rejects up to 60% of solar heat, keeping your cabin cooler and reducing A/C load on hot Virginia summers." },
              { icon: CheckCircle, title: "Virginia Legal", desc: "Every install is done to Virginia's tinting regulations. We ensure your front windows meet the 50% VLT minimum requirement." },
              { icon: ArrowRight, title: "Enhanced Privacy", desc: "Darker rear windows deter smash-and-grab theft and give you privacy without sacrificing visibility from inside." },
            ].map((item, i) => (
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            TINTING QUESTIONS FROM VIENNA DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT VIENNA DRIVERS SAY ABOUT OUR TINTING" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free window tinting quote from Northern Virginia's top-rated installer. Just 15 minutes from Vienna.
          </p>
      ...
      <NearbyAreas city="Vienna" service="tint" />
