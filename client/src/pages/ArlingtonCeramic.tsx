 ...
 * Ceramic Coating in Ceramic Coating in Arlington, VA
 * URL: /ceramic-coating-arlington-va
 */
...
const faqs = [
  {
    q: "Do you serve Ceramic Coating in Arlington, VA for PPF?",
    a: "Yes — we serve Arlington and all of Northern Virginia from our shop at 4215 Walney Rd Suite R, Chantilly, VA 20151. Arlington is about 25 minutes from our Chantilly shop via I-66 or Route 50.",
  },
  {
    q: "How much does PPF cost near Arlington?",
  ...
  {
    q: "Is PPF worth it driving on the Dulles Toll Road near Arlington?",
    a: "Absolutely. The Dulles Toll Road and Route 7 near Arlington see heavy truck traffic and frequent construction. PPF is one of the best investments to protect your paint from rock chips and road debris in this area.",
  },
  {
  ...
  {
    q: "Do you offer PPF for Tesla, BMW, and luxury vehicles near Arlington?",
...
const nearbyAreas = [
  "Arlington", "Chantilly", "Herndon", "Fairfax", "Vienna",
  "Rosslyn", "Ballston", "Clarendon", "Pentagon City", "Crystal City",
];

export default function ArlingtonCeramic() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Ceramic Coating Arlington VA | Car Ceramic Coating Near Me"
        description="Top-rated ceramic coating installer serving Ceramic Coating in Arlington, VA. Rock chip protection, self-healing PPF, and full-vehicle coverage. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/ceramic-coating-arlington-va"
        jsonLd={[
          {
            ...
            "areaServed": ["Ceramic Coating in Arlington, VA", "Chantilly, VA", "Northern Virginia"],
            "aggregateRating": {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Ceramic Coating in Arlington, VA", "item": "https://www.skylinecustomshop.com/ceramic-coating-arlington-va" }
            ]
          }
        ]}
      />
      ...
      <section className="relative min-h-[55vh] flex items-end pb-16 overflow-hidden">
        ...
        <div className="container relative z-10 pt-32">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[#E85D04] text-sm font-bold tracking-widest uppercase">Ceramic Coating in Arlington, VA</span>
          </div>
          <div className="max-w-4xl">
            ...
            <h1 className="font-['Bebas_Neue',sans-serif] text-6xl md:text-8xl lg:text-9xl leading-none text-white mb-4">
              ...
              <span className="text-[#E85D04]">ARLINGTON</span>
            </h1>
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated ceramic coating installer, just 20 minutes from Arlington via I-66 or Route 50. Protect your paint from rock chips and road debris with self-healing film.
            </p>
      ...
      {/* Why PPF near Arlington */}
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why Ceramic Coating in Arlington</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              { icon: Shield, title: "Dulles Toll Road Defense", desc: "The Dulles Toll Road and Route 7 near Arlington see heavy truck traffic. PPF absorbs impacts before they reach your paint." },
      ...
      <section className="py-20 bg-[#0A0A0A]">
        <div className="container text-center">
          ...
          <p className="text-zinc-500 text-sm max-w-xl mx-auto">
            Our shop is at 4215 Walney Rd Suite R, Chantilly, VA 20151 — just 20 minutes from Arlington via I-66 or Route 50. Free parking on site.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            CERAMIC COATING QUESTIONS FROM ARLINGTON DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT ARLINGTON DRIVERS SAY ABOUT OUR CERAMIC COATING" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free ceramic coating quote from Northern Virginia's top-rated installer. Just 20 minutes from Arlington.
          </p>
      ...
      <NearbyAreas city="Arlington" service="ceramic" />
