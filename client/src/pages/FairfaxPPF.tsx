 ...
 * Paint Protection Film in Fairfax, VA
 * URL: /ppf-fairfax-va
 */
...
const faqs = [
  {
    q: "Do you serve Fairfax, VA for PPF?",
    a: "Yes — we serve Fairfax and all of Northern Virginia from our shop at 4215 Walney Rd Suite R, Chantilly, VA 20151. Fairfax is about 15 minutes away via I-66 or Route 50.",
  },
  {
    q: "How much does PPF cost near Fairfax?",
  ...
  {
    q: "Is PPF worth it driving on I-66 and Route 50 near Fairfax?",
    a: "Absolutely. I-66 and Route 50 near Fairfax see heavy truck traffic and ongoing construction. PPF is one of the best investments to protect your paint from rock chips and road debris in this area.",
  },
  {
  ...
  {
    q: "Do you offer PPF for Tesla, BMW, and luxury vehicles near Fairfax?",
...
export default function FairfaxPPF() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="PPF Fairfax VA | Paint Protection Film Near Me"
        description="Top-rated paint protection film installer serving Fairfax, VA. Rock chip protection, self-healing PPF, and full-vehicle coverage. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/ppf-fairfax-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Fairfax, VA", "item": "https://www.skylinecustomshop.com/ppf-fairfax-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <h1 className="font-['Bebas_Neue',sans-serif] text-6xl md:text-8xl lg:text-9xl leading-none text-white mb-4">
              PPF NEAR<br />
              <span className="text-[#E85D04]">FAIRFAX</span>
            </h1>
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated PPF installer, just 15 minutes from Fairfax via I-66. Protect your paint from rock chips and road debris with self-healing film.
            </p>
      ...
      {/* Why PPF near Fairfax */}
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why PPF in Fairfax</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              { icon: Shield, title: "I-66 Rock Chip Defense", desc: "I-66 and Route 50 near Fairfax are high-traffic corridors with heavy trucks. PPF absorbs impacts before they reach your paint." },
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            PPF QUESTIONS FROM FAIRFAX DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT FAIRFAX DRIVERS SAY ABOUT OUR PPF" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free PPF quote from Northern Virginia's top-rated installer. Just 15 minutes from Fairfax.
          </p>
      ...
      <NearbyAreas city="Fairfax" service="ppf" />
