 ...
 * Paint Protection Film in Falls Church, VA
 * URL: /ppf-falls-church-va
 */
...
const faqs = [
  {
    q: "Do you install PPF for cars in Falls Church, VA?",
    a: "Yes — we serve Falls Church and all of Northern Virginia from our shop at 4215 Walney Rd Suite R, Chantilly, VA 20151. Falls Church is about 20 minutes from our Chantilly location via I-66 or Route 7.",
  },
  {
    q: "How much does PPF cost near Falls Church?",
  ...
  {
    q: "Is PPF worth it for driving on Route 7 and I-66 near Falls Church?",
    a: "Absolutely. Route 7 and I-66 near Falls Church see heavy commuter and truck traffic with frequent construction debris. PPF is one of the best investments to protect your paint from rock chips and road damage in this corridor.",
  },
  {
  ...
  {
    q: "Do you offer PPF for Tesla, BMW, and luxury vehicles near Falls Church?",
...
export default function FallsChurchPPF() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="PPF Falls Church VA | Paint Protection Film Near Me"
        description="Top-rated paint protection film installer serving Falls Church, VA. Rock chip protection, self-healing PPF, and full-vehicle coverage. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/ppf-falls-church-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Falls Church, VA", "item": "https://www.skylinecustomshop.com/ppf-falls-church-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated PPF installer, just 20 minutes from Falls Church via I-66 or Route 7. Protect your paint from rock chips and road debris with self-healing film.
            </p>
      ...
      {/* Why PPF near Falls Church */}
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why PPF in Falls Church</p>
            <h2 className="font-['Bebas_Neue',sans-serif] text-5xl text-white">DEFEND YOUR PAINT ON NOVA ROADS</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              { icon: Shield, title: "Route 7 & I-66 Defense", desc: "The Route 7 and I-66 corridor near Falls Church carries heavy commuter and truck traffic. PPF absorbs rock chips and road debris before they reach your paint." },
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            PPF QUESTIONS FROM FALLS CHURCH DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT FALLS CHURCH DRIVERS SAY ABOUT OUR PPF" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free PPF quote from Northern Virginia's top-rated installer. Just 20 minutes from Falls Church.
          </p>
      ...
      <NearbyAreas city="Falls Church" service="ppf" />
