 ...
 * Vinyl Wraps in Vienna, VA
 * URL: /vinyl-wraps-vienna-va
 */
...
const faqs = [
  {
    q: "Do you serve Vienna, VA for vinyl wraps?",
    a: "Yes — we serve Vienna and all of Northern Virginia from our shop at 4215 Walney Rd Suite R, Chantilly, VA 20151. Vienna is about 15 minutes away via Route 123 or I-66.",
  },
  {
    q: "How much does a vinyl wrap cost near Vienna?",
    a: "Full vehicle wrap pricing starts around $2,500–$4,000 for most sedans, depending on vehicle size and film type. Partial wraps and accent wraps are priced lower. Contact us for a free quote.",
  },
  {
    q: "How long does a vinyl wrap last?",
    a: "A professionally installed vinyl wrap typically lasts 5–7 years with proper care. Cast vinyl films from premium brands like 3M, Avery Dennison, and Oracal offer the best longevity.",
  },
  {
    q: "Can a vinyl wrap be removed without damaging paint?",
    a: "Yes — when installed and removed properly, vinyl wraps do not damage factory paint. In fact, wraps protect the original paint underneath from UV exposure and minor abrasions.",
  },
  {
    q: "What colors and finishes are available for vinyl wraps near Vienna?",
    a: "We offer thousands of colors and finishes including gloss, matte, satin, chrome, brushed metal, color-shift, and custom printed designs. If you can imagine it, we can wrap it.",
  },
  {
    q: "How long does a full vinyl wrap take?",
...
const nearbyAreas = [
  "Vienna", "Chantilly", "Fairfax", "Herndon", "Reston",
  "McLean", "Tysons", "Centreville", "Oakton", "Merrifield",
];

export default function ViennaWrap() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Vinyl Wraps Vienna VA | Car Wrap Near Me"
        description="Top-rated vinyl wrap installer serving Vienna, VA. Full vehicle wraps, partial wraps, and custom designs. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/vinyl-wraps-vienna-va"
        jsonLd={[
          {
            ...
            "areaServed": ["Vienna, VA", "Chantilly, VA", "Northern Virginia"],
            "aggregateRating": {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Vienna, VA", "item": "https://www.skylinecustomshop.com/vinyl-wraps-vienna-va" }
            ]
          }
        ]}
      />
      ...
      <section className="relative min-h-[55vh] flex items-end pb-16 overflow-hidden">
        ...
        <div className="container relative z-10 pt-32">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[#E85D04] text-sm font-bold tracking-widest uppercase">Vienna, VA</span>
          </div>
          <div className="max-w-4xl">
            ...
            <h1 className="font-['Bebas_Neue',sans-serif] text-6xl md:text-8xl lg:text-9xl leading-none text-white mb-4">
              CAR WRAPS NEAR<br />
              <span className="text-[#E85D04]">VIENNA</span>
            </h1>
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated vinyl wrap installer, just 15 minutes from Vienna via Route 123. Transform your vehicle's look with thousands of colors and finishes.
            </p>
            <div className="flex flex-wrap gap-3 mb-6">
              {["5.0 ★ Google Rating", "Free Quotes", "1000+ Colors", "3M & Avery Films"].map((b) => (
      ...
      {/* Why Wraps near Vienna */}
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why Vinyl Wraps in Vienna</p>
            <h2 className="font-['Bebas_Neue',sans-serif] text-5xl text-white">TRANSFORM YOUR VEHICLE'S LOOK</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              { icon: Shield, title: "Paint Protection", desc: "Vinyl wrap acts as a protective layer over your factory paint, shielding it from UV rays, minor abrasions, and road debris." },
              { icon: Star, title: "Endless Colors", desc: "Choose from thousands of colors and finishes — gloss, matte, satin, chrome, color-shift, and custom printed designs." },
              { icon: CheckCircle, title: "Reversible", desc: "Unlike a respray, vinyl wraps can be removed without damaging the original paint — perfect for leased vehicles." },
              { icon: ArrowRight, title: "Cost Effective", desc: "A full vinyl wrap costs significantly less than a quality paint job and can be updated whenever you want a new look." },
            ].map((item, i) => (
      ...
      <section className="py-20 bg-[#0A0A0A]">
        <div className="container text-center">
          ...
          <p className="text-zinc-500 text-sm max-w-xl mx-auto">
            Our shop is at 4215 Walney Rd Suite R, Chantilly, VA 20151 — just 15 minutes from Vienna via Route 123. Free parking on site.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            VINYL WRAP QUESTIONS FROM VIENNA DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT VIENNA DRIVERS SAY ABOUT OUR WRAPS" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free vinyl wrap quote from Northern Virginia's top-rated installer. Just 15 minutes from Vienna.
          </p>
      ...
      <NearbyAreas city="Vienna" service="wrap" />
