 ...
 * Window Tinting in Centreville, VA
 * URL: /window-tinting-centreville-va
 */
...
const faqs = [
  {
    q: "Do you offer window tinting near Centreville, VA?",
  ...
  {
    q: "What is the legal tint limit in Virginia?",
    a: "Virginia law requires front side windows to allow at least 50% of light in (VLT), rear side windows at least 35%, and the rear window at least 35%. We ensure all our tint jobs are fully Virginia-legal.",
  },
  {
    q: "How much does window tinting cost near Centreville?",
  ...
  },
  {
    ...
    a: "Ceramic tint uses nano-ceramic particles instead of dye or metal. It blocks up to 99% of UV rays and significantly more heat than standard film — without interfering with GPS, phone signals, or radio. It's worth every penny for NoVA summers.",
  },
  {
    q: "How long does window tinting take?",
    a: "Most vehicles can be tinted in 2–4 hours. We recommend waiting 24–48 hours before rolling down windows to allow the film to fully cure.",
  },
  {
    q: "Do you tint windshields?",
    a: "Yes — we offer legal windshield tint strips and full windshield ceramic film where permitted. We'll advise on what's legal and optimal for your vehicle and driving needs.",
  },
];
...
export default function CentrevilleTint() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Window Tinting Centreville VA | Ceramic Tint Near Me"
        description="Premium ceramic window tinting in Centreville, VA. Heat-rejecting, UV-blocking, Virginia-legal film. Lifetime warranty. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/window-tinting-centreville-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Centreville, VA", "item": "https://www.skylinecustomshop.com/window-tinting-centreville-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Beat the Northern Virginia heat with ceramic window film that blocks up to 99% of UV rays and dramatically reduces cabin temperature. Virginia-legal. Lifetime warranty.
            </p>
            <div className="flex flex-wrap gap-3 mb-6">
              {["5.0 ★ Google Rating", "Virginia-Legal Film", "Ceramic & Standard Options", "Lifetime Warranty"].map((b) => (
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            ...
            <h2 className="font-['Bebas_Neue',sans-serif] text-5xl text-white">STAY COOL ON NOVA ROADS</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              { icon: Sun, title: "Heat Rejection", desc: "Ceramic film blocks up to 60% of solar heat — your AC works less and your cabin stays comfortable even in August." },
              { icon: Shield, title: "99% UV Blocking", desc: "Protect your skin and your interior from UV radiation that causes fading, cracking, and long-term damage." },
              { icon: Star, title: "No Signal Interference", desc: "Unlike metallic films, ceramic tint won't block GPS, cell signals, or radio — perfect for modern vehicles." },
              { icon: CheckCircle, title: "Virginia-Legal", desc: "We know Virginia tint laws inside and out. Every job leaves our shop fully compliant with state regulations." },
            ].map((item, i) => (
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            TINTING QUESTIONS FROM CENTREVILLE DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT CENTREVILLE DRIVERS SAY ABOUT OUR WINDOW TINTING" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free window tinting quote from Northern Virginia's top-rated installer. Just 10 minutes from Centreville.
          </p>
      ...
      <NearbyAreas city="Centreville" service="tint" />
