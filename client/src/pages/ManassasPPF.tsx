 ...
 * Paint Protection Film in Manassas, VA
 * URL: /ppf-manassas-va
 */
...
const faqs = [
  {
    q: "Do you install PPF for cars in Manassas, VA?",
    a: "Yes — we serve Manassas and all of Northern Virginia from our shop at 4215 Walney Rd Suite R, Chantilly, VA 20151. Manassas is about 20 minutes from our Chantilly location via I-66 or Route 28.",
  },
  {
    q: "How much does PPF cost near Manassas?",
  ...
  {
    q: "Is PPF worth it for driving on I-66 and Route 28 near Manassas?",
    a: "Absolutely. The I-66 and Route 28 corridor near Manassas sees heavy truck traffic and ongoing construction. PPF is one of the best investments to protect your paint from rock chips and road debris in this area.",
  },
  {
  ...
  {
    q: "Do you offer PPF for Tesla, BMW, and luxury vehicles near Manassas?",
...
export default function ManassasPPF() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="PPF Manassas VA | Paint Protection Film Near Me"
        description="Top-rated paint protection film installer serving Manassas, VA. Rock chip protection, self-healing PPF, and full-vehicle coverage. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/ppf-manassas-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Manassas, VA", "item": "https://www.skylinecustomshop.com/ppf-manassas-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated PPF installer, just 20 minutes from Manassas via I-66 or Route 28. Protect your paint from rock chips and road debris with self-healing film.
            </p>
      ...
      {/* Why PPF near Manassas */}
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why PPF in Manassas</p>
            <h2 className="font-['Bebas_Neue',sans-serif] text-5xl text-white">DEFEND YOUR PAINT ON PRINCE WILLIAM ROADS</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              { icon: Shield, title: "I-66 & Route 28 Defense", desc: "The I-66 and Route 28 corridor near Manassas carries heavy truck and construction traffic. PPF absorbs rock chips and road debris before they reach your paint." },
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            PPF QUESTIONS FROM MANASSAS DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT MANASSAS DRIVERS SAY ABOUT OUR PPF" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free PPF quote from Northern Virginia's top-rated installer. Just 20 minutes from Manassas.
          </p>
      ...
      <NearbyAreas city="Manassas" service="ppf" />
