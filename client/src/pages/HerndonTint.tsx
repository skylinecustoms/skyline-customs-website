 ...
 * Window Tinting in Herndon, VA
 * URL: /window-tinting-herndon-va
 */
...
const faqs = [
  {
    q: "Do you offer window tinting near Herndon, VA?",
  ...
  {
    q: "How much does window tinting cost near Herndon?",
  ...
  {
    q: "Do you tint commercial vehicles near Herndon?",
    a: "Yes — we tint commercial vans, trucks, and fleet vehicles for Herndon-area businesses. Contact us for fleet pricing and scheduling.",
  },
];
...
export default function HerndonTint() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Window Tinting Herndon VA | Ceramic Tint Near Me"
        description="Premium ceramic window tinting in Herndon, VA. Heat-rejecting, UV-blocking, Virginia-legal film. Lifetime warranty. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/window-tinting-herndon-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Herndon, VA", "item": "https://www.skylinecustomshop.com/window-tinting-herndon-va" }
            ]
          }
        ]}
      />
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            TINTING QUESTIONS FROM HERNDON DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT HERNDON DRIVERS SAY ABOUT OUR WINDOW TINTING" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free window tinting quote from Northern Virginia's top-rated installer. Just 10–15 minutes from Herndon.
          </p>
      ...
      <NearbyAreas city="Herndon" service="tint" />
