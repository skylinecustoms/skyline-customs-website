 ...
 * Paint Protection Film in Alexandria, VA
 * URL: /ppf-alexandria-va
 */
...
const faqs = [
  {
    q: "Do you serve Alexandria, VA for PPF?",
  ...
  {
    q: "Is PPF worth it driving on I-395 and the GW Parkway near Alexandria?",
    a: "Absolutely. The Dulles Toll Road and Route 7 near Reston see heavy truck traffic and frequent construction. PPF is one of the best investments to protect your paint from rock chips and road debris in this area.",
  },
  {
...
const nearbyAreas = [
  "Alexandria", "Chantilly", "Fairfax", "McLean",
  "Arlington", "Springfield", "Annandale", "Burke", "Lorton",
];

export default function AlexandriaPPF() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="PPF Alexandria VA | Paint Protection Film Near Me"
        description="Top-rated paint protection film installer serving Alexandria, VA. Rock chip protection, self-healing PPF, and full-vehicle coverage. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/ppf-alexandria-va"
        jsonLd={[
          {
            ...
            "areaServed": ["Alexandria, VA", "Chantilly, VA", "Northern Virginia"],
            "aggregateRating": {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Alexandria, VA", "item": "https://www.skylinecustomshop.com/ppf-alexandria-va" }
            ]
          }
        ]}
      />
      ...
      <section className="relative min-h-[55vh] flex items-end pb-16 overflow-hidden">
        ...
        <div className="container relative z-10 pt-32">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[#E85D04] text-sm font-bold tracking-widest uppercase">Alexandria, VA</span>
          </div>
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated PPF installer, just 25 minutes from Alexandria via I-66 or Route 50. Protect your paint from rock chips and road debris with self-healing film.
            </p>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why PPF in Alexandria</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              { icon: Shield, title: "I-395 & GW Parkway Defense", desc: "I-395 and the GW Parkway near Alexandria see heavy commuter traffic and road debris. PPF absorbs impacts before they reach your paint." },
              ...
              { icon: CheckCircle, title: "12-Year Warranty", desc: "Our STEK DYNOshield film comes with a manufacturer-backed 12-year warranty against yellowing, cracking, and peeling." },
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            PPF QUESTIONS FROM ALEXANDRIA DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT ALEXANDRIA DRIVERS SAY ABOUT OUR PPF" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free PPF quote from Northern Virginia's top-rated installer. Just 25 minutes from Alexandria.
          </p>
      ...
      <NearbyAreas city="Alexandria" service="ppf" />
