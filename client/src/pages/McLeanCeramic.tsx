 ...
 * Paint Protection Film in McLean, VA
 * URL: /ceramic-coating-mclean-va
 */
...
const faqs = [
  {
    q: "Do you serve McLean, VA for ceramic coating?",
    a: "Yes — we serve Reston and all of Northern Virginia from our shop at 4215 Walney Rd Suite R, Chantilly, VA 20151. McLean is about 20 minutes from our Chantilly shop via Route 66 or the Beltway (I-495).",
  },
  {
    q: "How much does PPF cost near McLean?",
  ...
  {
    q: "Is PPF worth it for luxury vehicles in McLean?",
    a: "Absolutely. The I-495 Capital Beltway and Route 123 near McLean see heavy commuter traffic and frequent construction. PPF is one of the best investments to protect your paint from rock chips and road debris in this area.",
  },
  {
  ...
  {
    q: "Do you offer PPF for Tesla, BMW, and luxury vehicles near McLean?",
...
const nearbyAreas = [
  "McLean", "Chantilly", "Herndon", "Fairfax", "Vienna",
  "Sterling", "Ashburn", "Dulles", "Centreville", "McLean",
];

export default function McLeanCeramic() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Ceramic Coating McLean VA | Car Ceramic Coating Near Me"
        description="Top-rated ceramic coating installer serving McLean, VA. Rock chip protection, self-healing PPF, and full-vehicle coverage. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/ceramic-coating-mclean-va"
        jsonLd={[
          {
            ...
            "areaServed": ["McLean, VA", "Chantilly, VA", "Northern Virginia"],
            "aggregateRating": {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Reston, VA", "item": "https://www.skylinecustomshop.com/ceramic-coating-mclean-va" }
            ]
          }
        ]}
      />
      ...
      <section className="relative min-h-[55vh] flex items-end pb-16 overflow-hidden">
        ...
        <div className="container relative z-10 pt-32">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[#E85D04] text-sm font-bold tracking-widest uppercase">McLean, VA</span>
          </div>
          <div className="max-w-4xl">
            ...
            <h1 className="font-['Bebas_Neue',sans-serif] text-6xl md:text-8xl lg:text-9xl leading-none text-white mb-4">
              ...
              <span className="text-[#E85D04]">McLEAN</span>
            </h1>
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated ceramic coating installer, just 20 minutes from McLean via the Dulles Toll Road. Protect your paint from rock chips and road debris with self-healing film.
            </p>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              { icon: Shield, title: "Dulles Toll Road Defense", desc: "The I-495 Capital Beltway and Route 123 near McLean see heavy commuter traffic. PPF absorbs impacts before they reach your paint." },
      ...
      <section className="py-20 bg-[#0A0A0A]">
        <div className="container text-center">
          ...
          <p className="text-zinc-500 text-sm max-w-xl mx-auto">
            Our shop is at 4215 Walney Rd Suite R, Chantilly, VA 20151 — just 20 minutes from McLean via the Dulles Toll Road. Free parking on site.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            CERAMIC COATING QUESTIONS FROM McLEAN DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT McLEAN DRIVERS SAY ABOUT OUR CERAMIC COATING" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free ceramic coating quote from Northern Virginia's top-rated installer. Just 20 minutes from McLean.
          </p>
      ...
      <NearbyAreas city="McLean" service="ceramic" />
