 ...
 * Window Tinting in Woodbridge, VA
 * URL: /window-tinting-woodbridge-va
 */
...
const faqs = [
  {
    q: "Do you offer window tinting in Woodbridge, VA?",
  ...
  {
    q: "What are Virginia's window tint laws for Woodbridge drivers?",
  ...
  {
    q: "How much does window tinting cost near Woodbridge?",
...
export default function WoodbridgeTint() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Window Tinting Woodbridge VA | Car Window Tint Near Me"
        description="Top-rated window tinting installer serving Woodbridge, VA. Ceramic & carbon film, Virginia-legal tint, UV protection. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/window-tinting-woodbridge-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Woodbridge, VA", "item": "https://www.skylinecustomshop.com/window-tinting-woodbridge-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated window tint installer, just 30 minutes from Woodbridge via I-95 or the Prince William Parkway. Virginia-legal ceramic and carbon film that blocks heat, UV, and glare.
            </p>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why Window Tinting in Woodbridge</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              { icon: Sun, title: "Solar Heat Rejection", desc: "Ceramic tint blocks up to 60% of solar heat — a major comfort upgrade for Northern Virginia's hot summers and stop-and-go traffic on I-95 near Woodbridge and Dale City." },
              ...
              { icon: Star, title: "Glare Reduction", desc: "Reduce eye strain from sun glare and headlights during Northern Virginia's busy commutes — especially on I-95 heading north in the morning." },
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            WINDOW TINT QUESTIONS FROM WOODBRIDGE DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT WOODBRIDGE DRIVERS SAY ABOUT OUR WINDOW TINTING" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free window tint quote from Northern Virginia's top-rated installer. Just 30 minutes from Woodbridge.
          </p>
      ...
      <NearbyAreas city="Woodbridge" service="tint" />
