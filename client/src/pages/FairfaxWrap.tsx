 ...
 * Vinyl Wraps in Fairfax, VA
 * URL: /vinyl-wraps-fairfax-va
 */
...
import { Palette, MapPin, Phone, Shield, CheckCircle, ArrowRight, ChevronDown } from "lucide-react";
import { useState } from "react";
import NearbyAreas from "@/components/NearbyAreas";

const faqs = [
  {
    q: "Do you offer vinyl wraps near Fairfax, VA?",
    a: "Yes — we serve Fairfax and all of Northern Virginia from our shop in Chantilly, just 15 minutes away via I-66 or Route 50.",
  },
  {
    q: "How much does a vinyl wrap cost near Fairfax?",
    a: "Full-vehicle wrap pricing depends on vehicle size and film selection. Most sedans start around $2,500–$4,000. SUVs and trucks are priced higher. Partial wraps and accent wraps are available at lower price points. Contact us for a free quote.",
  },
  {
  ...
  },
  {
    ...
    a: "A professionally installed vinyl wrap typically lasts 5–7 years with proper care. Keeping the vehicle garaged and hand-washing regularly will maximize the lifespan.",
  },
  {
    q: "What colors and finishes are available near Fairfax?",
    a: "We offer hundreds of colors and finishes including gloss, matte, satin, chrome, brushed metal, color-shift, and more. We can match virtually any color or create a fully custom design.",
  },
  {
    q: "Can vinyl wrap protect my paint?",
    a: "Yes — vinyl wrap acts as a physical barrier against minor scratches, stone chips, and UV fading. It protects your original paint and can actually improve resale value by keeping the factory finish in pristine condition.",
  },
];
...
export default function FairfaxWrap() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Vinyl Wraps Fairfax VA | Car Wrap Near Me"
        description="Top-rated vinyl wrap installer serving Fairfax, VA. Full-vehicle wraps, partial wraps, and custom designs. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/vinyl-wraps-fairfax-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Fairfax, VA", "item": "https://www.skylinecustomshop.com/vinyl-wraps-fairfax-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Transform your vehicle with a professional vinyl wrap just 15 minutes from Fairfax. Hundreds of colors and finishes, fully reversible, with a 5–7 year lifespan.
            </p>
            <div className="flex flex-wrap gap-3 mb-6">
              {["5.0 ★ Google Rating", "Free Quotes", "Fully Reversible", "500+ Colors & Finishes"].map((b) => (
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why Wrap in Fairfax</p>
            <h2 className="font-['Bebas_Neue',sans-serif] text-5xl text-white">UNLIMITED CUSTOMIZATION FOR NOVA DRIVERS</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              { icon: Palette, title: "500+ Colors & Finishes", desc: "Gloss, matte, satin, chrome, brushed metal, color-shift — we have hundreds of options to make your vision a reality." },
              { icon: Shield, title: "Paint Protection", desc: "Vinyl wrap acts as a physical barrier against minor scratches, stone chips, and UV fading — protecting your factory paint underneath." },
              { icon: CheckCircle, title: "Fully Reversible", desc: "Change your mind? Vinyl wrap removes cleanly without damaging your original paint — perfect for leased vehicles." },
              { icon: ArrowRight, title: "5–7 Year Lifespan", desc: "Professionally installed vinyl wrap lasts 5–7 years with proper care. Protect your investment with our maintenance tips." },
            ].map((item, i) => (
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            VINYL WRAP QUESTIONS FROM FAIRFAX DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT FAIRFAX DRIVERS SAY ABOUT OUR WRAPS" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free vinyl wrap quote from Northern Virginia's top-rated installer. Just 15 minutes from Fairfax.
          </p>
      ...
      <NearbyAreas city="Fairfax" service="wrap" />
