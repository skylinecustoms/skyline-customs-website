 ...
 * Vinyl Wraps in Woodbridge, VA
 * URL: /vinyl-wraps-woodbridge-va
 */
...
const faqs = [
  {
    q: "Do you offer vinyl wraps for cars in Woodbridge, VA?",
  ...
  {
    q: "How much does a vinyl wrap cost near Woodbridge?",
  ...
  {
    q: "What colors and finishes are available for vinyl wraps near Woodbridge?",
...
export default function WoodbridgeWrap() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Vinyl Wraps Woodbridge VA | Car Wrap Near Me"
        description="Top-rated vinyl wrap installer serving Woodbridge, VA. Full vehicle wraps, partial wraps, color changes, and custom designs. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/vinyl-wraps-woodbridge-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Woodbridge, VA", "item": "https://www.skylinecustomshop.com/vinyl-wraps-woodbridge-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated vinyl wrap installer, just 30 minutes from Woodbridge via I-95 or the Prince William Parkway. Full color changes, partial wraps, and custom designs using 3M, Avery Dennison, and KPMF films.
            </p>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why Vinyl Wraps in Woodbridge</p>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            VINYL WRAP QUESTIONS FROM WOODBRIDGE DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT WOODBRIDGE DRIVERS SAY ABOUT OUR VINYL WRAPS" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free vinyl wrap quote from Northern Virginia's top-rated installer. Just 30 minutes from Woodbridge.
          </p>
      ...
      <NearbyAreas city="Woodbridge" service="wrap" />
