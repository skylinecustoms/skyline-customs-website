 ...
 * Ceramic Coating in Manassas, VA
 * URL: /ceramic-coating-manassas-va
 */
...
const faqs = [
  {
    q: "Do you offer ceramic coating for cars in Manassas, VA?",
  ...
  {
    q: "How much does ceramic coating cost near Manassas?",
  ...
  {
    q: "Is ceramic coating worth it for a daily driver in Prince William County?",
  ...
  {
    q: "Do you offer ceramic coating for Tesla and luxury vehicles near Manassas?",
...
export default function ManassasCeramic() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Ceramic Coating Manassas VA | Car Ceramic Coating Near Me"
        description="Top-rated ceramic coating installer serving Manassas, VA. Graphene & SiO2 coatings, paint correction, and hydrophobic protection. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/ceramic-coating-manassas-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Manassas, VA", "item": "https://www.skylinecustomshop.com/ceramic-coating-manassas-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated ceramic coating installer, just 20 minutes from Manassas via I-66 or Route 28. Graphene and SiO2 coatings that repel water, resist UV, and keep your car cleaner longer.
            </p>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why Ceramic Coating in Manassas</p>
            <h2 className="font-['Bebas_Neue',sans-serif] text-5xl text-white">LONG-TERM PAINT PROTECTION FOR PRINCE WILLIAM DRIVERS</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              ...
              { icon: Star, title: "Deep Gloss Finish", desc: "Ceramic coating amplifies your paint's depth and clarity, giving your car a wet-look shine that turns heads in Manassas, Gainesville, and beyond." },
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            CERAMIC COATING QUESTIONS FROM MANASSAS DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT MANASSAS DRIVERS SAY ABOUT OUR CERAMIC COATING" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free ceramic coating quote from Northern Virginia's top-rated installer. Just 20 minutes from Manassas.
          </p>
      ...
      <NearbyAreas city="Manassas" service="ceramic" />
