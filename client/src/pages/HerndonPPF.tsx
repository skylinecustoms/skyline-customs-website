 ...
 * Paint Protection Film in Herndon, VA
 * URL: /ppf-herndon-va
 */
...
const faqs = [
  {
    q: "Do you offer PPF near Herndon, VA?",
  ...
  {
    q: "How much does PPF cost near Herndon?",
  ...
  {
    q: "Is PPF worth it for Dulles Toll Road commuters?",
    a: "Absolutely. The Dulles Toll Road and Route 28 corridor near Herndon see heavy truck traffic and construction debris year-round. PPF is the most effective way to protect your paint from rock chips and road damage.",
  },
  {
  ...
  {
    q: "Do you offer PPF for luxury and exotic vehicles?",
    a: "Absolutely. We specialize in high-end vehicles including Tesla, BMW, Mercedes, Porsche, Audi, and exotics. Our computer-cut patterns are precision-fit for every make and model.",
  },
  {
    q: "What PPF brands do you use?",
    a: "We install STEK DYNOshield — one of the most respected PPF films in the industry. It features self-healing technology and comes with a 12-year manufacturer warranty.",
  },
];
...
export default function HerndonPPF() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="PPF Herndon VA | Paint Protection Film Near Me"
        description="Top-rated paint protection film installer serving Herndon, VA. Rock chip protection, self-healing PPF, and full-vehicle coverage. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/ppf-herndon-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Herndon, VA", "item": "https://www.skylinecustomshop.com/ppf-herndon-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated PPF installer, just 10–15 minutes from Herndon. Protect your paint from Dulles Toll Road rock chips with self-healing film.
            </p>
            <div className="flex flex-wrap gap-3 mb-6">
              {["5.0 ★ Google Rating", "Free Quotes", "STEK DYNOshield Film", "12-Year Warranty"].map((b) => (
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why PPF near Herndon</p>
            <h2 className="font-['Bebas_Neue',sans-serif] text-5xl text-white">PROTECT YOUR PAINT ON DULLES ROADS</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              { icon: Shield, title: "Dulles Corridor Defense", desc: "The Dulles Toll Road and Route 28 near Herndon are high-debris corridors. PPF absorbs impacts before they reach your paint." },
              ...
              { icon: CheckCircle, title: "12-Year Warranty", desc: "STEK DYNOshield films come with a manufacturer-backed 12-year warranty against yellowing, cracking, and peeling." },
      ...
      <section className="py-20 bg-[#0A0A0A]">
        <div className="container text-center">
          ...
          <p className="text-zinc-500 text-sm max-w-xl mx-auto">
            Located at 4215 Walney Rd Suite R, Chantilly, VA 20151 — just 10–15 minutes from Herndon via Route 28 or the Dulles Toll Road.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            PPF QUESTIONS FROM HERNDON DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT HERNDON DRIVERS SAY ABOUT OUR PPF" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free PPF quote from Northern Virginia's top-rated installer. Just 10–15 minutes from Herndon.
          </p>
      ...
      <NearbyAreas city="Herndon" service="ppf" />
