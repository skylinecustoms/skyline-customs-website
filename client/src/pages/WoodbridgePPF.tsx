 ...
 * Paint Protection Film in Woodbridge, VA
 * URL: /ppf-woodbridge-va
 */
...
const faqs = [
  {
    q: "Do you install PPF for cars in Woodbridge, VA?",
    a: "Yes — we serve Woodbridge and all of Northern Virginia from our shop at 4215 Walney Rd Suite R, Chantilly, VA 20151. Woodbridge is about 30 minutes from our Chantilly location via I-95 or the Prince William Parkway.",
  },
  {
    q: "How much does PPF cost near Woodbridge?",
  ...
  {
    q: "Is PPF worth it for driving on I-95 near Woodbridge?",
    a: "Absolutely. I-95 near Woodbridge is one of the busiest and most debris-prone highways in Northern Virginia. Rock chips from trucks and construction vehicles are a constant hazard — PPF is the most effective way to protect your paint.",
  },
  {
  ...
  {
    q: "Do you offer PPF for Tesla, BMW, and luxury vehicles near Woodbridge?",
...
export default function WoodbridgePPF() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="PPF Woodbridge VA | Paint Protection Film Near Me"
        description="Top-rated paint protection film installer serving Woodbridge, VA. Rock chip protection, self-healing PPF, and full-vehicle coverage. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/ppf-woodbridge-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Woodbridge, VA", "item": "https://www.skylinecustomshop.com/ppf-woodbridge-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated PPF installer, just 30 minutes from Woodbridge via I-95 or the Prince William Parkway. Protect your paint from I-95 rock chips and road debris with self-healing film.
            </p>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why PPF in Woodbridge</p>
            <h2 className="font-['Bebas_Neue',sans-serif] text-5xl text-white">DEFEND YOUR PAINT ON I-95 & PRINCE WILLIAM ROADS</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              { icon: Shield, title: "I-95 Rock Chip Defense", desc: "I-95 near Woodbridge carries some of the heaviest truck traffic in Virginia. PPF absorbs rock chips and road debris before they reach your paint." },
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            PPF QUESTIONS FROM WOODBRIDGE DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT WOODBRIDGE DRIVERS SAY ABOUT OUR PPF" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free PPF quote from Northern Virginia's top-rated installer. Just 30 minutes from Woodbridge.
          </p>
      ...
      <NearbyAreas city="Woodbridge" service="ppf" />
