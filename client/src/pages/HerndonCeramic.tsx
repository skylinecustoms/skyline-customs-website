 ...
 * Ceramic Coating in Herndon, VA
 * URL: /ceramic-coating-herndon-va
 */
...
const faqs = [
  {
    q: "Do you offer ceramic coating near Herndon, VA?",
  ...
  {
    q: "How much does ceramic coating cost near Herndon?",
  ...
  {
    q: "Is ceramic coating worth it for Herndon commuters?",
    a: "Absolutely. Herndon drivers face heavy highway use, bird droppings from the Dulles corridor, and tree sap from residential areas. Ceramic coating makes your car dramatically easier to maintain and protects against all of these.",
  },
  {
...
export default function HerndonCeramic() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Ceramic Coating Herndon VA | Car Detailing Near Me"
        description="Professional ceramic coating in Herndon, VA. Nano-ceramic protection, paint correction, and showroom gloss. 5.0 stars on Google. Free quotes."
        canonical="https://www.skylinecustomshop.com/ceramic-coating-herndon-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Herndon, VA", "item": "https://www.skylinecustomshop.com/ceramic-coating-herndon-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Nano-ceramic paint protection that delivers showroom gloss, hydrophobic water beading, and UV defense. Serving Herndon and all of Northern Virginia.
            </p>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            CERAMIC COATING QUESTIONS FROM HERNDON DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT HERNDON DRIVERS SAY ABOUT OUR CERAMIC COATING" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free ceramic coating quote from Northern Virginia's top-rated detailer. Just 10–15 minutes from Herndon.
          </p>
      ...
      <NearbyAreas city="Herndon" service="ceramic" />
