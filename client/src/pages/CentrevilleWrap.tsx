 ...
 * Vinyl Wraps in Centreville, VA
 * URL: /vinyl-wraps-centreville-va
 */
...
const faqs = [
  {
    q: "Do you offer vinyl wraps near Centreville, VA?",
  ...
  {
    q: "How much does a vinyl wrap cost near Centreville?",
  ...
  {
    q: "Do you offer fleet wraps near Centreville?",
    a: "Yes — we work with local businesses in Centreville, Manassas, and Fairfax on fleet graphics and branded vehicle wraps. Contact us for fleet pricing and turnaround times.",
  },
];
...
export default function CentrevilleWrap() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Vinyl Wraps Centreville VA | Car Wrap Near Me"
        description="Custom vinyl wraps in Centreville, VA. Full wraps, partial wraps, color changes, and fleet graphics. 5.0 stars on Google. Free quotes."
        canonical="https://www.skylinecustomshop.com/vinyl-wraps-centreville-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Centreville, VA", "item": "https://www.skylinecustomshop.com/vinyl-wraps-centreville-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Transform your vehicle with a custom vinyl wrap. Full color changes, partial wraps, matte finishes, and fleet graphics — serving Centreville and all of Northern Virginia.
            </p>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              ...
              { icon: CheckCircle, title: "Fleet Graphics", desc: "Turn your work vehicles into rolling billboards. We offer fleet wraps and branded graphics for Centreville-area businesses." },
            ].map((item, i) => (
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            VINYL WRAP QUESTIONS FROM CENTREVILLE DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT CENTREVILLE DRIVERS SAY ABOUT OUR VINYL WRAPS" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free vinyl wrap quote from Northern Virginia's top-rated installer. Just 10 minutes from Centreville.
          </p>
      ...
      <NearbyAreas city="Centreville" service="wrap" />
