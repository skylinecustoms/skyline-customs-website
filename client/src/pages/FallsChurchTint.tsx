 ...
 * Window Tinting in Falls Church, VA
 * URL: /window-tinting-falls-church-va
 */
...
const faqs = [
  {
    q: "Do you offer window tinting in Falls Church, VA?",
  ...
  {
    q: "What are Virginia's window tint laws for Falls Church drivers?",
  ...
  {
    q: "How much does window tinting cost near Falls Church?",
...
export default function FallsChurchTint() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Window Tinting Falls Church VA | Car Window Tint Near Me"
        description="Top-rated window tinting installer serving Falls Church, VA. Ceramic & carbon film, Virginia-legal tint, UV protection. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/window-tinting-falls-church-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Falls Church, VA", "item": "https://www.skylinecustomshop.com/window-tinting-falls-church-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated window tint installer, just 20 minutes from Falls Church via I-66 or Route 7. Virginia-legal ceramic and carbon film that blocks heat, UV, and glare.
            </p>
      ...
      {/* Why Tint near Falls Church */}
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why Window Tinting in Falls Church</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
            {[
              { icon: Sun, title: "Solar Heat Rejection", desc: "Ceramic tint blocks up to 60% of solar heat — a major comfort upgrade for Northern Virginia's hot summers and stop-and-go traffic on Route 7 and I-66." },
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            WINDOW TINT QUESTIONS FROM FALLS CHURCH DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT FALLS CHURCH DRIVERS SAY ABOUT OUR WINDOW TINTING" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free window tint quote from Northern Virginia's top-rated installer. Just 20 minutes from Falls Church.
          </p>
      ...
      <NearbyAreas city="Falls Church" service="tint" />
