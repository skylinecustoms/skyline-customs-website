...
const faqs = [
  {
    q: "Do you serve McLean, VA for window tinting?",
...
export default function McLeanTint() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Window Tinting McLean VA | Car Tint Near Me"
        description="Top-rated window tinting installer serving McLean, VA. Rock chip protection, self-healing PPF, and full-vehicle coverage. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/window-tinting-mclean-va"
        jsonLd={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Reston, VA", "item": "https://www.skylinecustomshop.com/window-tinting-mclean-va" }
            ]
          }
        ]}
      />
        ...
        <div className="container relative z-10 pt-32">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated window tinting installer, just 20 minutes from McLean via the Dulles Toll Road. Protect your paint from rock chips and road debris with self-healing film.
            </p>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            TINTING QUESTIONS FROM McLEAN DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT McLEAN DRIVERS SAY ABOUT OUR TINTING" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free window tinting quote from Northern Virginia's top-rated installer. Just 20 minutes from McLean.
          </p>
      ...
      <NearbyAreas city="McLean" service="tint" />
