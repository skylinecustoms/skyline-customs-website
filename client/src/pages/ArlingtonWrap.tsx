 ...
 * Vinyl Wraps in Vinyl Wraps in Arlington, VA
 * URL: /vinyl-wraps-arlington-va
 */
...
const faqs = [
  {
    q: "Do you serve Vinyl Wraps in Arlington, VA for PPF?",
...
export default function ArlingtonWrap() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-['DM_Sans',sans-serif]">
      <SEO
        title="Vinyl Wraps Arlington VA | Car Wrap Near Me"
        description="Top-rated vinyl wrap installer serving Vinyl Wraps in Arlington, VA. Rock chip protection, self-healing PPF, and full-vehicle coverage. Free quotes. 5.0 stars on Google."
        canonical="https://www.skylinecustomshop.com/vinyl-wraps-arlington-va"
        jsonLd={[
          {
            ...
            "areaServed": ["Vinyl Wraps in Arlington, VA", "Chantilly, VA", "Northern Virginia"],
            "aggregateRating": {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 4, "name": "Vinyl Wraps in Arlington, VA", "item": "https://www.skylinecustomshop.com/vinyl-wraps-arlington-va" }
            ]
          }
        ]}
      />
      ...
      <section className="relative min-h-[55vh] flex items-end pb-16 overflow-hidden">
        ...
        <div className="container relative z-10 pt-32">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[#E85D04] text-sm font-bold tracking-widest uppercase">Vinyl Wraps in Arlington, VA</span>
          </div>
          <div className="max-w-4xl">
            ...
            <p className="text-zinc-300 text-lg md:text-xl max-w-2xl leading-relaxed mb-6">
              Northern Virginia's top-rated vinyl wrap installer, just 20 minutes from Arlington via I-66 or Route 50. Protect your paint from rock chips and road debris with self-healing film.
            </p>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container">
          <div className="mb-12">
            <p className="text-[#E85D04] text-sm font-bold tracking-[0.3em] uppercase mb-3">Why Vinyl Wraps in Arlington</p>
      ...
      <section className="py-20 bg-[#0D0D0D]">
        <div className="container max-w-3xl">
          ...
          <h2 className="font-['Bebas_Neue',sans-serif] text-4xl md:text-5xl text-white mb-10">
            VINYL WRAP QUESTIONS FROM ARLINGTON DRIVERS
          </h2>
      ...
      <Testimonials title="WHAT ARLINGTON DRIVERS SAY ABOUT OUR WRAPS" />
      ...
      <section className="py-20 bg-[#E85D04]">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Get a free vinyl wrap quote from Northern Virginia's top-rated installer. Just 20 minutes from Arlington.
          </p>
      ...
      <NearbyAreas city="Arlington" service="wrap" />
