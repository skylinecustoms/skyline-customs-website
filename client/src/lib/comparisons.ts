...
export const PPF_VS_CERAMIC: ComparisonData = {
  ...
  columns: [
    { key: "ppf", name: "Paint Protection Film", sub: "STEK DYNOshield", href: "/services/ppf", price: "From $1,800 (partial front) · $2,400 full front", bestFor: "Stopping rock chips, gravel, and scratches on the front end. The only product that physically absorbs impacts." },
    { key: "ceramic", name: "Ceramic Coating", sub: "Gtechniq Crystal Serum", href: "/services/ceramic-coating", price: "From $800 (5-year) · $1,300 (7-year)", bestFor: "Gloss, easier washing, and protection from UV, bird droppings, and water spots across the whole car." },
    { key: "both", name: "PPF + Ceramic", sub: "Our most common combo", href: "/get-a-quote?service=ppf", price: "Full front + full-car coating from $3,200", bestFor: "New cars and anything you plan to keep. Film where chips happen, coating everywhere for gloss and maintenance." },
  ],
  rows: [
    ...
    { label: "Typical price at Skyline", cells: { ppf: { text: "$1,800 partial front · $2,400 full front · from $4,500 full car" }, ceramic: { text: "$800 Crystal · $1,300 Ultimate" }, both: { text: "From about $3,200 for full front + full-car coating" } } },
  ],
  verdicts: [
  ...
  faqs: [
    ...
    { q: "Which is cheaper, PPF or ceramic coating?", a: "Ceramic coating is cheaper up front: $800 to $1,300 for the whole car versus $2,400 for a full-front PPF install. They protect against different things, so the right question is which damage you are trying to prevent." },
...
export const TINT_COMPARISON: ComparisonData = {
  ...
  columns: [
    { key: "dyed", name: "Dyed Tint", sub: "Entry-level film", price: "Typically $150–$250 elsewhere", bestFor: "Looks only. Cheapest way to get a dark car; fades, turns purple, and does little for heat." },
    { key: "carbon", name: "Carbon Tint", sub: "Mid-tier film", price: "Typically $250–$400 elsewhere", bestFor: "A step up: no purple fade and moderate heat rejection, but still well short of ceramic on infrared." },
    { key: "ceramic", name: "Ceramic Tint", sub: "GeoShield Pro Nano Ceramic", href: "/services/window-tinting", price: "$350 sides & rear · $425 full · $575 with windshield", bestFor: "Real heat rejection, 99% UV, signal-safe, lifetime warranty. The only film we install." },
  ],
  rows: [
    ...
    { label: "Price for a sedan", cells: { dyed: { text: "$150–$250 at shops that carry it (we do not)." }, carbon: { text: "$250–$400 at shops that carry it (we do not)." }, ceramic: { text: "$350 sides & rear, $425 full vehicle, $575 full plus windshield." } } },
  ],
  verdicts: [
    ...
    { title: "Carbon: fine, but ask why", body: "Carbon is a reasonable middle option at a shop that carries it. The gap to ceramic is usually $100 or less on a sedan, and the heat difference on a black interior in August is not small.", href: "/faq", cta: "Tint FAQ" },
  ...
  faqs: [
    { q: "Is ceramic tint worth the extra cost over carbon?", a: "For most Northern Virginia drivers, yes. Ceramic rejects roughly 80% of infrared heat versus about half for carbon, so the cabin cools faster and the AC works less. At Skyline the whole-car price is $425, which is close to what many shops charge for carbon." },
    ...
    { q: "How much does ceramic window tint cost in Chantilly, VA?", a: "Standard tint (four side windows and rear) starts at $350, full vehicle at $425, and full vehicle plus windshield at $575, all in GeoShield Pro Nano Ceramic with a lifetime warranty." },
  ],
