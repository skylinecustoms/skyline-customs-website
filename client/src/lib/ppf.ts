...
export const PPF_FAQS: { q: string; a: string }[] = [
  ...
  { q: "Is there a deposit for PPF?", a: "Yes. Once you approve your quote, a 20% deposit reserves your install date and locks in your price. It goes toward your total, so you pay the remaining balance at pickup after you've walked every panel with us. The deposit is fully refundable at any time, no questions asked." },
