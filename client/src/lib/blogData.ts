...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: "Searching \"window tinting near me\" in Chantilly, VA? What separates ceramic tint that lasts from a bargain job, and why 140+ drivers left us five stars.",
    date: "April 23, 2026",
  ...
  },
  {
    ...
    excerpt: "Virginia's 2026 window tint law explained: legal VLT for sedans, SUVs, and trucks, reflectivity limits, medical exemptions, and fines. Stay inspection-legal.",
    date: "March 23, 2026",
    updated: "September 19, 2026",
    readTime: "5 min read",
    category: "Window Tinting",
  ...
  },
  {
    ...
    excerpt: "Pollen, acid rain, road salt, and stronger sun hit Northern Virginia paint every spring. How a Gtechniq ceramic coating protects your car and why to pair it with PPF.",
    date: "March 2, 2026",
    updated: "September 19, 2026",
    readTime: "6 min read",
  ...
  },
  {
    ...
    excerpt: "PPF is the only product that stops rock chips. What it protects, which coverage fits Northern Virginia highways, and whether full front PPF is worth it for you.",
    date: "March 5, 2026",
    updated: "September 19, 2026",
    readTime: "7 min read",
