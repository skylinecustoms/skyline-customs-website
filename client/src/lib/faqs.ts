...
export const FAQ_GROUPS: FaqGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "How much does PPF cost?", a: "Partial front (bumper plus partial hood) starts at $1,800. Full front — bumper, hood, fenders, mirrors, headlights, and A-pillars — is $2,400. Full-vehicle coverage starts at $4,500 for sedans and $5,500 for SUVs. All prices are confirmed at inspection." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "How much does ceramic coating cost?", a: "Ceramic with no correction starts at $800 for sedans. The Crystal Package (Stage 2 correction plus a 5-year coating) starts at $1,300, and the Ultimate Coating (Stage 3 correction plus a 7-year coating) starts at $1,500. SUVs and trucks are slightly higher." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "How much does window tinting cost?", a: "GeoShield Pro Nano Ceramic packages start at $280 for four side windows, $425 for the most popular rear package, and $575 for every window including the windshield. Windshield-only is $200. All packages include a nationwide lifetime warranty." },
